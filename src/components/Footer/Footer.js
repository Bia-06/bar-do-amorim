      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            <h3>Bar do Amorim</h3>
            <p>O melhor da região desde 2019</p>
            <p>R. Júlio de Mesquita, 582 - Jardim Maria Izabel, Marília - SP, 17515-230</p>
          </div>
          ...
          <div className="footer-section">
            ...
            <p>
              ...
              Segunda a Sábado: 09h às 01h
            </p>
            <p>
              <span className="contact-icon">
                <img
                  className="footer-icon-img"
                  src="/images/icons/happyhour.png"
                  alt="Happy Hour"
                />
              </span>
              Happy Hour: Seg à Sex 16h às 20h
            </p>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a 
                href="https://www.facebook.com/bardoamorimoficial" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/bardoamorim/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="social-link"
              ...
              <a 
                href="https://wa.me/5514996943024" 
                target="_blank" 
                rel="noopener noreferrer"
                className="social-link"
                aria-label="WhatsApp"
